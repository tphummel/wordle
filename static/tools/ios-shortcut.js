...
const githubQueryLink = `https://github.com/tphummel/wordle/new/main/content/w/new?quick_pull=1&commit-choice=quick-pull&message=add+puzzle+${report.puzzleDate}+${{data.game.dayOffset}}&target_branch=${report.puzzleDate}_${data.game.dayOffset}&same_repo=1&guidance_task=&labels=puzzle&value=${encodedFileText}&filename=${filename}`;
