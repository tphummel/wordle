---
title: Back Half Alphabet Pangrams
---

Definition: Puzzles where every letter from N to Z appears at least once across all guesses.

{{< om.inline >}}
  {{ $wordles := where .Site.RegularPages "Section" "w" }}
  {{ $found := partial "back-half-alphabet-pangrams.html" $wordles }}
